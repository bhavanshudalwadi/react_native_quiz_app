...
const EditUser = ({ navigation, route }: any) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            {mode && mode === 'ADD' ? 
                <Button rounded="$full" alignSelf='center' w="$2/3" mt="$16" onPress={handleAddUser}>
                    <ButtonText>Add User</ButtonText>
                </Button>
            :<></>}
            {mode && mode === 'EDIT' ? 
                <Button rounded="$full" alignSelf='center' w="$2/3" mt="$16" onPress={handleUpdateUser}>
